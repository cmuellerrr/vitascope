                ...
                return this.each(function () {
                    ...
                    if (!data) { //check if event is already assigned
                        ...
                        $(obj).bind('click.YouTubePopup', function (event) {
                            ...
                            //Format Vimeo URL
                            YouTubeURL = window.location.protocol + "//player.vimeo.com/video/" + youtubeId + "?autoplay=" + options.autoplay;
                            YouTubeURL += "&title=" + options.vTitle + "&byline=" + options.vByline + "&portrait=" + options.vPortrait;
                            YouTubeURL += "&loop=" + options.vLoop + "&color=" + options.vColor;
